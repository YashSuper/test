...
$student=array(0 => array('id' => 'st1', 'name' => 'Hemant', 'dob' => strtotime("1990-02-01"), 'grade' => '12' ),
 ...
 2 => array('id' => 'st3', 'name' => 'Zubin', 'dob' => strtotime("1994-08-11"), 'grade' => '11' ));//  Array for subject code and its details r defined
$subs=array(array('grade' => 12, 'name' => 'math', 'code' => '12M', 'mm' => 60),
  ...
  array('grade' => 11, 'name' => 'hindi', 'code' => '11H', 'mm' => 70));// function to display subject for specific grades
function subs_of_grade ($grade,$subs)
{
  foreach ($subs as $subject) {
    if($subject['grade'] == $grade){
      ...
      //sample output
subs_of_grade (12,$subs);// Array for marks obtained of each student with student id as key
$obtainedMarks = array ('st1' => array ('math' => '100', 'eng' => '00', 'hindi' => '70'),
  'st2' => array ('math' => '80', 'eng' => '70', 'hindi' => '62'),
  'st3' => array ('math' => '80', 'eng' => '40', 'hindi' => '36'));// function to display student with its marks obtained in each subject
...
sub_by_student('st1',$obtainedMarks);// Function to get the result(pass or fail) for each student on the basis of his marks
